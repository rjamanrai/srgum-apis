  ...
  return (
    <div id="site-content" className="site-content clearfix">
      <div id="inner-content" className="inner-content-wrap">
        <section className="page-title bg-st-6">
          <Head>
            <title>Podcasts | Srgum Radio | Punjabi Radio | Player</title>
            <meta
              name="title"
              content="Podcasts of Srgum Radio | Punjabi Radio "
            />
          </Head>
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <div className="baner-title fl-st-4">
                  <h2
        ...
        <section className="tf-listing fl-section-top">
          <div className="container">
            <div className="row">
              <div className="col-lg-6">
                <div
                  className="box-list-music fl-st-1 wow fadeInLeft"
                  data-wow-delay="200ms"
                  data-wow-duration="1500ms"
                >
                  <div className="box-feature">
                    <img src="image/list-music1.jpg" alt="image" />
                  </div>
                  <div className="box-content">
                    <h3 className="title">Fashion is Life Podcast</h3>
                    <p className="sub-title">25 Episod</p>
                    <hr />
                    <p className="wrap">
                      ...
                      fadolorit to the consectetur elit.
                    </p>
                    <hr />
                    <div className="fl-list-play fl-st-2">
                      <ul className="fl-st-3">
                        <li>
                          <span className="box-icon-11">
                            <a href="#" className="player-m play-pause-button">
                              <i className="icon-playplay"></i>
                            </a>
                          </span>
                          <p className="name fl-st-3 muted6-color">
                            The Fire Deep Within
                          </p>
                          <span className="episod-2 muted5-color">
                            01 Episod
                          </span>
                        </li>
                        <li>
              ...
              <div className="col-lg-6">
                <div
                  className="box-list-music wow fadeInRight"
                  data-wow-delay="200ms"
                  data-wow-duration="1500ms"
                >
                  <div className="box-feature">
                    <img src="image/list-music2.jpg" alt="image" />
                  </div>
                  <div className="box-content">
                    <h3 className="title">Education Life Podcast</h3>
                    <p className="sub-title">25 Episod</p>
                    <hr />
                    <p className="wrap">
                      Grursus mal suada faci lisis Lorem ipsum dolarorit more a
        ...
        <section className="tf-about-us fl-st-1 fl-section">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <div className="box-about-us">
                  <div className="fl-title-heading ct">
                    ...
                    <div
                      className="box-icon-4 wow fadeInUp"
                      data-wow-delay="400ms"
                      data-wow-duration="1500ms"
                    >
                      <a
        ...
        <section className="tf-sub fl-st-3">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <div className="fl-flex fl-max fl-sub">
                  ...
                  <p
                    className="wrap-sub wow fadeInUp"
                    data-wow-delay="400ms"
                    data-wow-duration="1500ms"
                  >
