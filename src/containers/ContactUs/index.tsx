    ...
    <div id="site-content" className="site-content clearfix">
      <div id="inner-content" className="inner-content-wrap">
        <div className="page-content">
          <Head>
            <title>Contact us | Srgum Radio | Punjabi Radio | Player</title>
            <meta
              name="title"
              content="Contact us of Srgum Radio | Punjabi Radio "
            />
          </Head>
          ...
          <section className="tf-contact fl-section">
            <div className="container">
              <div className="row">
                <div className="col-lg-4 col-md-4 col-sx-12">
                  <div className="box-contact">
                    <div
                      className="icon-contact fl-st-1 wow fadeInDown"
                    ...
                    <div
                      className="box-content fl-st-1 wow fadeInUp "
                      data-wow-delay="100ms"
                      data-wow-duration="1500ms"
                    >
                    ...
                    >
                      ...
                      <ul>
                        <li>
                          <p className="sub">
                            Office Telephone :
                            <a href="tel:0029129102320"> 0029129102320</a>
                          </p>
                        </li>
                        <li>
                          <p className="sub">
                            Mobile :
                            <a href="tel:000232439493"> 000 2324 39493</a>
                          </p>
                        </li>
                      </ul>
                    </div>
                ...
                <div className="col-lg-4 col-md-4 col-sx-12">
                  <div className="box-contact">
                    <div
                      className="icon-contact fl-st-2  wow fadeInDown"
                          ...
                          <p className="sub">
                            ...
                            <a href="">
                              ...
                              <span
                                ...
                                data-cfemail="355b54585075425057465c41501b565a58"
                              >
                                test
                              </span>
                            </a>
                        ...
                        <li>
                          <p className="sub">
                            ...
                            <a href="">
                              ...
                              <span
                                className="__cf_email__"
                                data-cfemail="357c5b535a755a47504d1b565a58"
                              >
                                test
                              </span>
                            </a>
              ...
              <div className="row">
                <div className="col-12">
                  <h3
                    className="title-contact wow fadeInDown"
                    data-wow-delay="200ms"
                    data-wow-duration="1500ms"
                  >
                    CONTACT FORM
                  ...
                  <div className="form-contact">
                    ...
                    >
                      <div
                        className="row-form fl-st-2 wow fadeInUp"
                        data-wow-delay="100ms"
                        data-wow-duration="1500ms"
                      >
                        ...
                        <div className="col-form-6 fl-st-2 mgr-none">
                          ...
                          <span className="icon-form">
                            {" "}
                            <i className="icon-ic-m"></i>{" "}
                          </span>
                        </div>
                      </div>
                      <div
                        className="row-form wow fadeInUp"
                        data-wow-delay="200ms"
                        data-wow-duration="1500ms"
                      >
